...
local Path = function(self, ...)
	return (self.AnimatedLoss.Override or Update)(self, unpack(arg))
end

local OnAnimatedLossUpdate = function()
	return Path(this, "OnAnimatedLossUpdate", this.unit)
end
...
local Enable = function(self, unit)
	...
	if animatedLoss then
		...
		HookScript(self, "OnUpdate", OnAnimatedLossUpdate)
